    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>Bulk-Ug.</h1>
          ...
          <li><Link to="products" smooth={true} offset={-50} duration={500}>Software's and Apps</Link></li>
          <li><Link to="careers" smooth={true} offset={-50} duration={500}>Career's</Link></li>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
        ...
        <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="pricing" smooth={true} offset={-50} duration={500}>Products</Link></li>
